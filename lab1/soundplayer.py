...
class MusicPlayer(Frame):
    def __init__(self, root):
        ...
        self.volume.set(1.0)
        Scale(self, variable=self.volume, from_=0.0, to=1.0, resolution=0.1, command=self.changevolume, orient=HORIZONTAL).pack(**button_opt)
...
if __name__ == "__main__" :
    ...
    panel.pack()
    tk.protocol("WM_WM_DELETE_WINDOW", shutdown)
    tk.mainloop()